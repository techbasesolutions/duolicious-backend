...
def test_claim_reports_paused_and_halted(client, make_person):
    ...
    with api_tx() as tx:
        ...
        _set(tx, publication_enabled='false', external_access_enabled='true')
    ...
    with api_tx() as tx: _set(tx, publication_enabled='false')
...
def test_expire_approvals_paused_while_approvals_disabled(client, make_person):
    ...
    with api_tx() as tx:
        ...
        _set(tx, approvals_enabled='false')
...
def test_welcome_creates_candidate_without_invite_when_approvals_disabled(client, make_person, monkeypatch, capsys):
    ...
    assert "'invite_sent': False" in out and rk in out
